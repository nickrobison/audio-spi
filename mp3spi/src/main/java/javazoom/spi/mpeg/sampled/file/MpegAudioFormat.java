...
public class MpegAudioFormat extends TAudioFormat
{
     ...
     * @param properties
     */
    public MpegAudioFormat(Encoding encoding, float nFrequency, int SampleSizeInBits, int nChannels, int FrameSize, float FrameRate, boolean isBigEndian, Map<String, Object> properties)
    {
