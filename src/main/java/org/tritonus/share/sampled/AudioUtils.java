...
*/
    ...
    public static boolean isJavaSoundAudioEngine(DataLine line) {
        if (line != null) {
            ...
            return clazz.contains("MixerSourceLine")
                    || clazz.contains("MixerClip")
                    || clazz.contains("SimpleInputDevice");
        }
        return false;
    }
     ...
     */
    public static double linear2decibel(double linearFactor) {
        if (linearFactor <= 0.0) {
     ...
     */
    public static double decibel2linear(double decibels) {
