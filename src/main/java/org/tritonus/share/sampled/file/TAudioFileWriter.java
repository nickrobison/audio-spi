...
public abstract class TAudioFileWriter
    ...
    public int write(AudioInputStream audioInputStream,
        ...
        org.tritonus.share.sampled.file.TDataOutputStream dataOutputStream = new TSeekableDataOutputStream(file);
    ...
    public int write(AudioInputStream audioInputStream,
        ...
        long lLengthInBytes = AudioUtils.getLengthInBytes(audioInputStream);
        org.tritonus.share.sampled.file.TDataOutputStream dataOutputStream = new TNonSeekableDataOutputStream(outputStream);
        AudioOutputStream audioOutputStream =
                getAudioOutputStream(
                        outputFormat,
                        lLengthInBytes,
